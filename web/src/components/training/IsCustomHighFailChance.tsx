...
export default function IsCustomHighFailChance({ CustomFailureEnabled, enableCustomHighFailure, setCustomHighFailChance}: Props) {
    return (
        <label htmlFor="is-custom-high-failure" className="flex gap-2 items-center">
            ...
            <Tooltips>Each Rainbow Friendship = 1.5 points<br />Each Non-Maxed Friendship = 1 point<br />Each Orange or Maxed Friendship = 0 Point<br />If have hint, point + 1<br />Recommend High Point = 4<br />These Score Use to Set Condition Only Not Final Score</Tooltips>
        </label>
    );
}