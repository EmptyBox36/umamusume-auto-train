...
from utils.screenshot import enhance_image_for_ocr, enhance_image_for_ocr_2
...
def extract_percent(pil_img: Image.Image) -> int:
    ...
    result = reader.readtext(
        np.array(pil_img), allowlist="0123456789%"
    )  # keeps '%', drops letters:contentReference[oaicite:0]{index=0}
